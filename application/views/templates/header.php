					...
					<div class="navbar-header">
						<a class="navbar-brand" href="index.html">
							<!-- Logo icon --><b>
								...
								<!-- Dark Logo icon -->
								<img src="<?=base_url()?>_assets/material/images/logo-icon.png" alt="homepage" class="dark-logo" />
								<!-- Light Logo icon -->
								<img src="<?=base_url()?>_assets/material/images/logo-light-icon.png" alt="homepage" class="light-logo" />
							</b>
							<!--End Logo icon -->
							<!-- Logo text --><span>
								<!-- dark Logo text -->
								<img src="<?=base_url()?>_assets/material/images/logo-text.png" alt="homepage" class="dark-logo" />
								<!-- Light Logo text -->
								<img src="<?=base_url()?>_assets/material/images/logo-light-text.png" class="light-logo" alt="homepage" /></span>
							</a>
						</div>
						<!-- ============================================================== -->
						<!-- End Logo -->
								...
								<li class="nav-item"> <a class="nav-link nav-toggler hidden-md-up text-muted waves-effect waves-dark"
									...
									<li class="nav-item"> <a class="nav-link sidebartoggler hidden-sm-down text-muted waves-effect waves-dark"
												...
												<ul>
													...
													<li>
														<div class="message-center">
															<!-- Message -->
															<a href="#">
																<div class="user-img"> <img src="<?=base_url()?>_assets/material/images/users/1.jpg" alt="user"
															...
															<!-- Message -->
															<a href="#">
																<div class="user-img"> <img src="<?=base_url()?>_assets/material/images/users/2.jpg" alt="user"
															...
															<!-- Message -->
															<a href="#">
																<div class="user-img"> <img src="<?=base_url()?>_assets/material/images/users/3.jpg" alt="user"
															...
															<!-- Message -->
															<a href="#">
																<div class="user-img"> <img src="<?=base_url()?>_assets/material/images/users/4.jpg" alt="user"
										...
										<li class="nav-item dropdown">
											...
											aria-haspopup="true" aria-expanded="false"><img src="<?=base_url()?>_assets/material/images/users/1.jpg" alt="user"
											class="profile-pic" /></a>
											<div class="dropdown-menu dropdown-menu-right scale-up">
												<ul class="dropdown-user">
													<li>
														<div class="dw-user-box">
															<div class="u-img"><img src="<?=base_url()?>_assets/material/images/users/1.jpg" alt="user"></div>
															<div class="u-text">
																<h4>Steave Jobs</h4>
