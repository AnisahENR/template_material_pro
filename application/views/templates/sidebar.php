 ...
 <aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        <!-- User profile -->
        <div class="user-profile" style="background: url(<?=base_url()?>_assets/material/images/background/user-info.jpg) no-repeat;">
            <!-- User profile image -->
            <div class="profile-img"> <img src="<?=base_url()?>_assets/material/images/users/profile.png" alt="user" /> </div>
            <!-- User profile text-->
